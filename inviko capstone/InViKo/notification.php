...
{ 
 ...
 $notification= $_REQUEST['notification'];
  ...
  $q1="insert into dashboard_notification values('','$notification','$role','1')";
    mysqli_query($conn,$q1) or die(mysqli_error());        
     
} 

$grid="select * from dashboard_notification where status='1'";
                                ...
                                <div class="row">
                                    ...
                                    <span class="input-group-addon"> <i class="fa fa-binoculars text-primary"></i>
                                     ...
                                     <select name="role" class="form-control">
                                            ...
                                            <div class="col-lg-3 text-lg-right">
                                                <label for="Notification" class="form-control-label">Notification
                                                    *</label>
                                            </div>
                                            <div class="col-xl-6 col-lg-8">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-plus text-primary"></i></span>
                                                    <textarea rows="5" cols="50" placeholder=" "  id="notification" name="notification" class="form-control">
                                                    </textarea>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    <div>
                                        ...
                                        <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                            <thead>
                                                ...
                                                <tr role="row">                                                
                                                    <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1">Notification</th>
                                    ...
                                    ?>
                                           ...
                                           <td><?php echo $f[2]; ?></td> 
                                            ...
                                            data-placement="top" title="Delete" href="delete.php?ndelete=<?php echo $f[0];?>">
